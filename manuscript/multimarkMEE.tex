...
pbeta[(Intercept)] -1.2590 0.27604 0.0027604        0.02085
N                  35.3603 5.43211 0.0543211        0.31004
delta_1             0.4212 0.08117 0.0008117        0.01216
delta_2             0.4356 0.07996 0.0007996        0.01265

2. Quantiles for each variable:

                      2.5%     25%     50%     75%   97.5%
pbeta[(Intercept)] -1.8326 -1.4465 -1.2487 -1.0620 -0.7535
N                  27.0000 32.0000 34.0000 38.0000 48.0000
delta_1             0.2562  0.3673  0.4244  0.4782  0.5703
delta_2             0.2721  0.3818  0.4399  0.4920  0.5792
\end{Soutput}
\begin{Sinput}
...
pbeta[(Intercept)]                  N            delta_1            delta_2 
         175.26399          306.97405           44.54464           39.95661 
\end{Soutput}
\end{Schunk}
...
1. Empirical mean and standard deviation for each variable,
   plus standard error of the mean:
                         ...
                         Mean      SD  Naive SE Time-series SE
pbeta[(Intercept)]   -0.14505 0.13195 0.0004665       0.004521
phibeta[(Intercept)]  1.39905 0.28513 0.0010081       0.011372
alpha                 0.40530 0.11295 0.0003993       0.002603
sigma2_zphi           0.03712 0.09867 0.0003489       0.004207
delta_1               0.20192 0.04616 0.0001632       0.001583
delta_2               0.60387 0.05157 0.0001823       0.001129

2. Quantiles for each variable:

                          2.5%       25%      50%      75%  97.5%
pbeta[(Intercept)]   -0.389604 -0.237291 -0.15002 -0.05742 0.1245
phibeta[(Intercept)]  0.940375  1.200721  1.36546  1.55676 2.0510
alpha                 0.204653  0.324695  0.39904  0.47879 0.6438
sigma2_zphi           0.002649  0.007147  0.01393  0.03141 0.2105
delta_1               0.116826  0.169463  0.20025  0.23221 0.2971
delta_2               0.501039  0.569305  0.60480  0.63940 0.7023
\end{Soutput}
\end{Schunk}
...
1. Empirical mean and standard deviation for each variable,
   plus standard error of the mean:
       ...
       Mean      SD  Naive SE Time-series SE
p[1] 0.1366 0.05521 0.0005521       0.006385
c[2] 0.2651 0.05115 0.0005115       0.003045

2. Quantiles for each variable:

        2.5%     25%    50%    75%  97.5%
p[1] 0.04261 0.09569 0.1302 0.1716 0.2609
c[2] 0.17281 0.22827 0.2632 0.2989 0.3705
\end{Soutput}
\end{Schunk}
