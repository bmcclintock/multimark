...
pbeta[(Intercept)] -1.2373 0.24385 0.0024385       0.018141
N                  35.2105 5.22998 0.0522998       0.296915
delta_1             0.4292 0.07544 0.0007544       0.010690
delta_2             0.4429 0.07562 0.0007562       0.009382

2. Quantiles for each variable:

                      2.5%     25%     50%    75%   97.5%
pbeta[(Intercept)] -1.7275 -1.3981 -1.2291 -1.075 -0.7755
N                  28.0000 32.0000 34.0000 38.000 48.0000
delta_1             0.2715  0.3803  0.4320  0.482  0.5685
delta_2             0.2842  0.3943  0.4464  0.496  0.5816
\end{Soutput}
\begin{Sinput}
...
pbeta[(Intercept)]                  N            delta_1            delta_2 
         180.68842          310.26712           49.79658           64.95899 
\end{Soutput}
\end{Schunk}
...
1. Empirical mean and standard deviation for each variable,
   plus standard error of the mean:
                        ...
                        Mean      SD  Naive SE Time-series SE
pbeta[(Intercept)]   -0.3101 0.11498 0.0004065      0.0028133
phibeta[(Intercept)]  1.2522 0.19615 0.0006935      0.0054497
alpha                 0.5019 0.10397 0.0003676      0.0018396
sigma2_zphi           0.1829 0.91687 0.0032416      0.0831746
delta_1               0.2432 0.04656 0.0001646      0.0009639
delta_2               0.5195 0.05187 0.0001834      0.0008036

2. Quantiles for each variable:

                          2.5%       25%      50%      75%    97.5%
pbeta[(Intercept)]   -0.529286 -0.389366 -0.31131 -0.23345 -0.08007
phibeta[(Intercept)]  0.899317  1.124203  1.24228  1.37154  1.66477
alpha                 0.304830  0.429323  0.49990  0.57264  0.70831
sigma2_zphi           0.002707  0.007249  0.01492  0.03882  1.78635
delta_1               0.156710  0.210874  0.24146  0.27374  0.33840
delta_2               0.417687  0.484152  0.51957  0.55488  0.62058
\end{Soutput}
\end{Schunk}
...
1. Empirical mean and standard deviation for each variable,
   plus standard error of the mean:
       ...
       Mean      SD  Naive SE Time-series SE
p[1] 0.1300 0.05510 0.0005510       0.005125
c[2] 0.2372 0.05191 0.0005191       0.003892

2. Quantiles for each variable:

        2.5%    25%    50%    75%  97.5%
p[1] 0.04184 0.0887 0.1236 0.1648 0.2552
c[2] 0.14270 0.2001 0.2351 0.2708 0.3467
\end{Soutput}
\end{Schunk}
