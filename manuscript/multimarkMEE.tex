...
\usepackage{Sweave}
\begin{document}
\input{multimarkMEE-concordance}
...
pbeta[(Intercept)] -1.3632 0.25177 0.0025177       0.015807
N                  35.5843 5.29665 0.0529665       0.247142
delta_1             0.3768 0.07704 0.0007704       0.008827
delta_2             0.3935 0.07748 0.0007748       0.008153

2. Quantiles for each variable:

                      2.5%     25%     50%     75%   97.5%
pbeta[(Intercept)] -1.8588 -1.5329 -1.3626 -1.1870 -0.8876
N                  27.0000 32.0000 35.0000 39.0000 48.0000
delta_1             0.2316  0.3231  0.3762  0.4291  0.5313
delta_2             0.2467  0.3398  0.3925  0.4459  0.5489
\end{Soutput}
\begin{Sinput}
...
pbeta[(Intercept)]                  N            delta_1            delta_2 
         253.70774          459.31285           76.16803           90.32521 
\end{Soutput}
\end{Schunk}
...
1. Empirical mean and standard deviation for each variable,
   plus standard error of the mean:
                        ...
                        Mean      SD  Naive SE Time-series SE
pbeta[(Intercept)]   -0.3114 0.11386 0.0004025      0.0027095
phibeta[(Intercept)]  1.2668 0.19871 0.0007026      0.0056590
alpha                 0.5101 0.10517 0.0003718      0.0017993
sigma2_zphi           0.3381 1.96565 0.0069496      0.2490295
delta_1               0.2455 0.04684 0.0001656      0.0009793
delta_2               0.5218 0.05137 0.0001816      0.0007298

2. Quantiles for each variable:

                          2.5%       25%      50%      75%    97.5%
pbeta[(Intercept)]   -0.531093 -0.389086 -0.31272 -0.23533 -0.08282
phibeta[(Intercept)]  0.909615  1.136389  1.25806  1.38734  1.68459
alpha                 0.309685  0.436888  0.50911  0.58177  0.71768
sigma2_zphi           0.002876  0.007975  0.01665  0.04837  3.16274
delta_1               0.157869  0.213062  0.24398  0.27639  0.34106
delta_2               0.420641  0.487297  0.52198  0.55657  0.62187
\end{Soutput}
\end{Schunk}
...
1. Empirical mean and standard deviation for each variable,
   plus standard error of the mean:
       ...
       Mean      SD  Naive SE Time-series SE
p[1] 0.1317 0.05434 0.0005434       0.004925
c[2] 0.2519 0.05510 0.0005510       0.004527

2. Quantiles for each variable:

        2.5%     25%    50%    75%  97.5%
p[1] 0.03909 0.09228 0.1253 0.1656 0.2501
c[2] 0.15227 0.21297 0.2496 0.2884 0.3641
\end{Soutput}
\end{Schunk}
